...
class TestGeomFitting(ConverterTestCase):
    ...
    def test_geom_fitting_box(self):
        ...
        self.assertTrue(Gf.IsClose(scale, (0.47636932, 0.49139905, 0.5194262), self.eps))
        self.assertTrue(Gf.IsClose(translation, (0.03074589395921, 0.501516571216, -0.02411530172992), self.eps))
        self.assert_rotation_almost_equal(quat, Gf.Quatf(0.11115205, 0.86828923, 0.22571543, 0.42751792), self.eps)
        ...
        translation, pivot, quat, scale = usdex.core.getLocalTransformComponentsQuat(prim)
        self.assertTrue(Gf.IsClose(scale, (0.47636932, 0.49139905, 0.5194262), self.eps))
        self.assertTrue(Gf.IsClose(translation, (0.13713980789211, 0.012144646664811, 0.001516571216727), self.eps))
        self.assert_rotation_almost_equal(quat, Gf.Quatf(-0.44702968, 0.65726686, -0.26079687, 0.54785925), self.eps)
        ...
        self.assertEqual(cube.GetSizeAttr().Get(), 2)
        translation, pivot, quat, scale = usdex.core.getLocalTransformComponentsQuat(prim)
        self.assertTrue(Gf.IsClose(scale, (0.5716432, 0.5896788, 0.62331146), self.eps))
        self.assertTrue(Gf.IsClose(translation, (0.03713980789211, 0.012144646664811, 0.5015165712167), self.eps))
        self.assert_rotation_almost_equal(quat, Gf.Quatf(-0.44702968, 0.65726686, -0.26079687, 0.54785925), self.eps)
        ...
        self.assertEqual(cube.GetSizeAttr().Get(), 2)
        translation, pivot, quat, scale = usdex.core.getLocalTransformComponentsQuat(prim)
        self.assertTrue(Gf.IsClose(scale, (0.1, 0.15, 0.6), self.eps))
        self.assertTrue(Gf.IsClose(translation, (0, 0, 0), self.eps))
        self.assert_rotation_almost_equal(quat, Gf.Quatf(0, 0.70710677, 0, 0.70710677), self.eps)
        ...
        self.assertTrue(Gf.IsClose(scale, (0.1, 0.15, 0.6), self.eps))
        self.assertTrue(Gf.IsClose(translation, (0, 0, 0), self.eps))
        self.assert_rotation_almost_equal(quat, Gf.Quatf(0.5, 0.5, -0.5, 0.5), self.eps)
        ...
        self.assertTrue(Gf.IsClose(scale, (0.1, 0.15, 0.6), self.eps))
        self.assertTrue(Gf.IsClose(translation, (0, 0, 0), self.eps))
        self.assert_rotation_almost_equal(quat, Gf.Quatf(0.70710677, 0, 0, 0.70710677), self.eps)
    ...
    def test_geom_fitting_fitting_sphere(self):
        ...
        self.assertTrue(Gf.IsClose(sphere.GetRadiusAttr().Get(), 0.4957315243758671, self.eps))
        translation, pivot, quat, scale = usdex.core.getLocalTransformComponentsQuat(prim)
        self.assertTrue(Gf.IsClose(scale, (1, 1, 1), self.eps))
        self.assertTrue(Gf.IsClose(translation, (0.03074589395921, 0.501516571216, -0.02411530172992), self.eps))
        self.assert_rotation_almost_equal(quat, Gf.Quatf(0.11115205, 0.86828923, 0.22571543, 0.42751792), self.eps)
        ...
        sphere = UsdGeom.Sphere(prim)
        self.assertTrue(Gf.IsClose(sphere.GetRadiusAttr().Get(), 0.5948778292510405, self.eps))
        translation, pivot, quat, scale = usdex.core.getLocalTransformComponentsQuat(prim)
        self.assertTrue(Gf.IsClose(scale, (1, 1, 1), self.eps))
        self.assertTrue(Gf.IsClose(translation, (0.03713980789211, 0.012144646664811, 0.5015165712167), self.eps))
        self.assert_rotation_almost_equal(quat, Gf.Quatf(-0.44702968, 0.65726686, -0.26079687, 0.54785925), self.eps)
        ...
        sphere = UsdGeom.Sphere(prim)
        self.assertTrue(Gf.IsClose(sphere.GetRadiusAttr().Get(), 0.28333333333333327, self.eps))
        translation, pivot, quat, scale = usdex.core.getLocalTransformComponentsQuat(prim)
        self.assertTrue(Gf.IsClose(scale, (1, 1, 1), self.eps))
        self.assertTrue(Gf.IsClose(translation, (0, 0, 0), self.eps))
        self.assert_rotation_almost_equal(quat, Gf.Quatf(0, 0.70710677, 0, 0.70710677), self.eps)
    ...
    def test_geom_fitting_cylinder(self):
        ...
        self.assertTrue(Gf.IsClose(cylinder.GetRadiusAttr().Get(), 0.4838841777760525, self.eps))
        self.assertTrue(Gf.IsClose(cylinder.GetHeightAttr().Get(), 1.0388524351509925, self.eps))
        translation, pivot, quat, scale = usdex.core.getLocalTransformComponentsQuat(prim)
        self.assertTrue(Gf.IsClose(scale, (1, 1, 1), self.eps))
        self.assertTrue(Gf.IsClose(translation, (0.03074589395921, 0.501516571216, -0.02411530172992), self.eps))
        self.assert_rotation_almost_equal(quat, Gf.Quatf(0.11115205, 0.86828923, 0.22571543, 0.42751792), self.eps)
        ...
        translation, pivot, quat, scale = usdex.core.getLocalTransformComponentsQuat(prim)
        self.assertTrue(Gf.IsClose(scale, (1, 1, 1), self.eps))
        self.assertTrue(Gf.IsClose(translation, (0.1371398078921, 0.01214464666481, 0.00151657121672), self.eps))
        self.assert_rotation_almost_equal(quat, Gf.Quatf(-0.44702968, 0.65726686, -0.26079687, 0.54785925), self.eps)
        ...
        cylinder = UsdGeom.Cylinder(prim)
        self.assertEqual(cylinder.GetAxisAttr().Get(), UsdGeom.Tokens.z)
        self.assertTrue(Gf.IsClose(cylinder.GetRadiusAttr().Get(), 0.580661013331263, self.eps))
        self.assertTrue(Gf.IsClose(cylinder.GetHeightAttr().Get(), 1.2466229221811909, self.eps))
        translation, pivot, quat, scale = usdex.core.getLocalTransformComponentsQuat(prim)
        self.assertTrue(Gf.IsClose(scale, (1, 1, 1), self.eps))
        self.assertTrue(Gf.IsClose(translation, (0.03713980789211787, 0.012144646664811277, 0.5015165712167277), self.eps))
        self.assert_rotation_almost_equal(quat, Gf.Quatf(-0.44702968, 0.65726686, -0.26079687, 0.54785925), self.eps)
        ...
        cylinder = UsdGeom.Cylinder(prim)
        self.assertEqual(cylinder.GetAxisAttr().Get(), UsdGeom.Tokens.z)
        self.assertTrue(Gf.IsClose(cylinder.GetRadiusAttr().Get(), 0.1250000037252903, self.eps))
        self.assertTrue(Gf.IsClose(cylinder.GetHeightAttr().Get(), 1.2000000476837158, self.eps))
        translation, pivot, quat, scale = usdex.core.getLocalTransformComponentsQuat(prim)
        self.assertTrue(Gf.IsClose(scale, (1, 1, 1), self.eps))
        self.assertTrue(Gf.IsClose(translation, (0, 0, 0), self.eps))
        self.assert_rotation_almost_equal(quat, Gf.Quatf(0, 0.70710677, 0, 0.70710677), self.eps)
        ...
        cylinder = UsdGeom.Cylinder(prim)
        self.assertEqual(cylinder.GetAxisAttr().Get(), UsdGeom.Tokens.z)
        self.assertTrue(Gf.IsClose(cylinder.GetRadiusAttr().Get(), 0.12499999999999994, self.eps))
        self.assertTrue(Gf.IsClose(cylinder.GetHeightAttr().Get(), 1.2, self.eps))
        translation, pivot, quat, scale = usdex.core.getLocalTransformComponentsQuat(prim)
        self.assertTrue(Gf.IsClose(scale, (1, 1, 1), self.eps))
        self.assertTrue(Gf.IsClose(translation, (0, 0, 0), self.eps))
        self.assert_rotation_almost_equal(quat, Gf.Quatf(0.5, 0.5, -0.5, 0.5), self.eps)
        ...
        cylinder = UsdGeom.Cylinder(prim)
        self.assertEqual(cylinder.GetAxisAttr().Get(), UsdGeom.Tokens.z)
        self.assertTrue(Gf.IsClose(cylinder.GetRadiusAttr().Get(), 0.12499999999999997, self.eps))
        self.assertTrue(Gf.IsClose(cylinder.GetHeightAttr().Get(), 1.2, self.eps))
        translation, pivot, quat, scale = usdex.core.getLocalTransformComponentsQuat(prim)
        self.assertTrue(Gf.IsClose(scale, (1, 1, 1), self.eps))
        self.assertTrue(Gf.IsClose(translation, (0, 0, 0), self.eps))
    ...
    def test_geom_fitting_capsule(self):
        ...
        self.assertTrue(Gf.IsClose(capsule.GetRadiusAttr().Get(), 0.4838841777760525, self.eps))
        self.assertTrue(Gf.IsClose(capsule.GetHeightAttr().Get(), 0.5549682573749399, self.eps))
        translation, pivot, quat, scale = usdex.core.getLocalTransformComponentsQuat(prim)
        self.assertTrue(Gf.IsClose(scale, (1, 1, 1), self.eps))
        self.assertTrue(Gf.IsClose(translation, (0.03074589395921, 0.501516571216, -0.02411530172992), self.eps))
        self.assert_rotation_almost_equal(quat, Gf.Quatf(0.11115205, 0.86828923, 0.22571543, 0.42751792), self.eps)
        ...
        translation, pivot, quat, scale = usdex.core.getLocalTransformComponentsQuat(prim)
        self.assertTrue(Gf.IsClose(scale, (1, 1, 1), self.eps))
        self.assertTrue(Gf.IsClose(translation, (0.13713980789211788, 0.012144646664811277, 0.001516571216727658), self.eps))
        self.assert_rotation_almost_equal(quat, Gf.Quatf(-0.44702968, 0.65726686, -0.26079687, 0.54785925), self.eps)
        ...
        capsule = UsdGeom.Capsule(prim)
        self.assertEqual(capsule.GetAxisAttr().Get(), UsdGeom.Tokens.z)
        self.assertTrue(Gf.IsClose(capsule.GetRadiusAttr().Get(), 0.580661013331263, self.eps))
        self.assertTrue(Gf.IsClose(capsule.GetHeightAttr().Get(), 0.6659619088499279, self.eps))
        translation, pivot, quat, scale = usdex.core.getLocalTransformComponentsQuat(prim)
        self.assertTrue(Gf.IsClose(scale, (1, 1, 1), self.eps))
        self.assertTrue(Gf.IsClose(translation, (0.03713980789211787, 0.012144646664811277, 0.5015165712167277), self.eps))
        self.assert_rotation_almost_equal(quat, Gf.Quatf(-0.44702968, 0.65726686, -0.26079687, 0.54785925), self.eps)
        ...
        capsule = UsdGeom.Capsule(prim)
        self.assertEqual(capsule.GetAxisAttr().Get(), UsdGeom.Tokens.z)
        self.assertTrue(Gf.IsClose(capsule.GetRadiusAttr().Get(), 0.12499999999999994, self.eps))
        self.assertTrue(Gf.IsClose(capsule.GetHeightAttr().Get(), 1.075, self.eps))
        translation, pivot, quat, scale = usdex.core.getLocalTransformComponentsQuat(prim)
        self.assertTrue(Gf.IsClose(scale, (1, 1, 1), self.eps))
        self.assertTrue(Gf.IsClose(translation, (0, 0, 0), self.eps))
        self.assert_rotation_almost_equal(quat, Gf.Quatf(0, 0.70710677, 0, 0.70710677), self.eps)
        ...
        capsule = UsdGeom.Capsule(prim)
        self.assertEqual(capsule.GetAxisAttr().Get(), UsdGeom.Tokens.z)
        self.assertTrue(Gf.IsClose(capsule.GetRadiusAttr().Get(), 0.12499999999999997, self.eps))
        self.assertTrue(Gf.IsClose(capsule.GetHeightAttr().Get(), 1.075, self.eps))
        translation, pivot, quat, scale = usdex.core.getLocalTransformComponentsQuat(prim)
        self.assertTrue(Gf.IsClose(scale, (1, 1, 1), self.eps))
        self.assertTrue(Gf.IsClose(translation, (0, 0, 0), self.eps))
